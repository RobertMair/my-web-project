...
// current page link in the top nav, mobile menu, and footer.
        ...
        async function topNav() {
                ...
                const topNavLink = await waitForElement("#topnav-link-about");
                topNavLink.href = "#";
        ...
        async function mobileNav() {
                ...
                const mobileNavLink = await waitForElement("#mobile-link-about");
                mobileNavLink.href = "#";
        ...
        async function footerNav() {
                ...
                const footerNavLink = await waitForElement("#footer-link-about");
                footerNavLink.href = "#";
